#Cambiar la extensiÃ³n de este fichero a .sh
#!/bin/bash
...
#Se fija a 12 el nÂº de threads mÃ¡ximo (tantas como cores en un nodo)
export OMP_THREAD_LIMIT=12
echo "Numero de threads inicial: $OMP_THREAD_LIMIT"
#Se ejecuta HelloOMP que estÃ¡ en el directorio hello con distinto nÂº de threads
